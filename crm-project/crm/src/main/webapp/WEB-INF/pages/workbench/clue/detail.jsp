...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveBundActivityBtn").click(function () {
			...
			ids+="clueId=${clue.id}";//activityId=xxxx&activityId=xxxx&...&activityId=xxxx&clueId=xxxx
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${clue.fullname}${clue.appellation}<small>${cule.company}</small></h3>
		</div>
		...
		<c:forEach items="${remarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clur.company}</b> <small style="color: gray;"> ${remark.editFlag=='0'?remark.createTime:remark.editTime} 由${remark.editFlag=='0'?remark.createBy:remark.editBy}${remark.editFlag=='0'?'创建':'修改'}</small>
